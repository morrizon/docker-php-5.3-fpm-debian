...
RUN CFLAGS="-fPIC" && OPENSSL_VERSION="1.0.2n" \
      && cd /tmp \
      && mkdir openssl \
...
# removed because get openssl error
...
# directive not available for PHP 5.3. See http://php.net/manual/en/install.fpm.configuration.php#clear-env
#        echo; \
#        echo 'clear_env = no'; \
        echo; \
